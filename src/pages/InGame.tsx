...
const InGame = () => {
  ...
  const fetchPosts = async () => {
    try {
      const data = await postService.getPosts('ingame');
      setPosts(data);
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12 fade-in">
          <div className="flex justify-center mb-6">
            <Sword className="h-16 w-16 text-purple-400 pulse-glow" />
          </div>
          <h1 className="text-5xl font-bold gradient-text heading-font mb-4">
            In-Game Guide
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Master the art of playing Raiden Shogun with builds, artifacts, and strategies
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="glass-morphism border-2 border-purple-500/30 rounded-xl p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Element</h3>
            <p className="text-purple-300">Electro</p>
          </div>
          <div className="glass-morphism border-2 border-purple-500/30 rounded-xl p-6 text-center">
            <Sword className="h-8 w-8 text-purple-400 mx-auto mb-2" />
            <h3 className="text-lg font-semibold text-white mb-1">Weapon</h3>
            <p className="text-purple-300">Polearm</p>
          </div>
          <div className="glass-morphism border-2 border-purple-500/30 rounded-xl p-6 text-center">
            <Shield className="h-8 w-8 text-purple-400 mx-auto mb-2" />
            <h3 className="text-lg font-semibold text-white mb-1">Role</h3>
            <p className="text-purple-300">Support/DPS</p>
          </div>
        </div>
        ...
        {posts.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-bold text-gray-400 mb-2">No guides yet</h3>
            <p className="text-gray-500 mb-8">
              The guide section is empty. Visit the dashboard to add your first in-game guide.
            </p>
            <Link
              to="/dashboard"
